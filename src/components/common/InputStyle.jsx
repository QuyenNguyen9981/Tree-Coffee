...
const InputStyle = ({ className, type, label, row }) => {
  return (
    <div className="flex justify-center">
      <div
        className={`relative  min-h-[40px] mb-3 max-w-[578px] w-full bg-bgcolor rounded-md ${className}`}
      ...
      >
        <input
          ...
          placeholder={label}
          onInvalid={(e) => e.target.setCustomValidity(`Enter ${label} Here`)}
        />
